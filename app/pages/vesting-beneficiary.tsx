    ...
    <div className={styles.container}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.flexCol}>
            ...
            <div className={styles.flexCol}>
              ...
              {/* Vesting Actions - Grid layout for check and claim */}
              <div className={styles.grid + ' ' + styles.grid2}>
                <button
      ...
      <div className={styles.info}>
        ...
        <ol style={{ listStyleType: 'decimal', listStylePosition: 'inside', fontSize: '0.875rem' }}>
          ...
          <li style={{ marginBottom: '0.5rem' }}>Select a token mode (Testing or Production)</li>
          <li style={{ marginBottom: '0.5rem' }}><strong>💰 (Optional) Click "Check My Wallet Balance"</strong> to see your current token balance</li>
          <li style={{ marginBottom: '0.5rem' }}>Enter the EXACT vesting parameters from the creation transaction (get from admin or Etherscan logs)</li>
          <li style={{ marginBottom: '0.5rem' }}>Click "Find My Vesting Wallet" to locate your wallet</li>
          <li style={{ marginBottom: '0.5rem' }}>Click "Check Releasable Amount" to see how much you can claim from vesting</li>
          <li style={{ marginBottom: '0.5rem' }}>Wait for the cliff period to pass (shown in countdown timer)</li>
          <li style={{ marginBottom: '0.5rem' }}>Click "Claim Tokens" to release your vested tokens to your wallet!</li>
          <li>After claiming, check your wallet balance again to see the updated amount 🎉</li>
        </ol>
        <div className={styles.info} style={{ marginTop: '1rem', padding: '0.75rem', background: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: '0.5rem' }}>
          <p className={styles.textXs + ' ' + styles.fontBold}>
