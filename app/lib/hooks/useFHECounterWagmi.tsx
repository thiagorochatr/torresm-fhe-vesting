...
import { useDeployedContractInfo, type Contract } from "./useDeployedContractInfo";
import { useWagmiEthers } from "./useWagmiEthers";
import type { FhevmInstance } from "../fhevm-sdk/fhevmTypes";
import {
  buildParamsFromAbi,
  getEncryptionMethod,
  useFHEDecrypt,
...
export const useFHECounterWagmi = (parameters: {
  ...
  const { data: fheCounter } = useDeployedContractInfo({ contractName: "FHECounter", chainId });
